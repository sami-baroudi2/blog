            ...
            <?php else : ?> <!-- Lorsque la personne est déconnectée, il verra ces 2 sections dans le header. -->
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="cat1.php">Catégorie 1</a></li>
                        <li><a class="dropdown-item" href="cat2.php">Catégorie 2</a></li>
                        <li><a class="dropdown-item" href="cat3.php">Catégorie 3</a></li>
                    </ul>
                </div>
            <?php endif; ?>
        </nav>