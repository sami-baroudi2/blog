        ...
        <main class="footer-auto-bottom">
            ...
            <div class="zone">
                <div class="formulaire-update-profile-admin">
                    ...
                    <input class="form-admin-edit-profile" type="text" name="title" placeholder="Choisissez un titre"></input><br />
                    <input class="form-admin-edit-profile" type="text" name="article" placeholder="Contenu de l'article"></input><br />
